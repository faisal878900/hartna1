...
import 'package:hartna1/admin/helpers/order.dart';
...
//  getter
  ...
  UserProvider2.initialize() : _auth = FirebaseAuth.instance {
  ...
  Future<void> reload() async {
    _restaurant = (await _restaurantServices.getRestaurantById(id: user.uid)) as RestaurantModel;
  ...
  Future<bool> removeFromCart({Map cartItem}) async {
    ...
    try {
      _userServicse.removeFromCart(userId: _user.uid);
      return true;
    } catch (e) {
